...
public class TrailDataManager {
    ...
    private static TrailDataManager instance;  // Singleton instance

    // Private constructor to prevent instantiation
    private TrailDataManager() {
        objectMapper = new ObjectMapper();
    }

    /**
     * Provides the global point of access to the TrailDataManager instance.
     * @return the single instance of TrailDataManager
     */
    public static synchronized TrailDataManager getInstance() {
        if (instance == null) {
            instance = new TrailDataManager();
        }
        return instance;
    }
